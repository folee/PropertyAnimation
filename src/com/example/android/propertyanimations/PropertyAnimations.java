...
/**
 * This example shows how to use property animations, specifically ObjectAnimator, to perform various view animations.
 * Compare this approach to that of the ViewAnimations demo, which shows how to achieve similar effects using the
 * pre-3.0 animation APIs.
 * 
 * Watch the associated video for this demo on the DevBytes channel of developer.android.com or on YouTube at
